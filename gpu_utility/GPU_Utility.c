...
gpu_device_mapping gpu_device_bus[MAX_GPU_NUM] = {
	{217, 0x4c, EM_GPU_DEVICE_1},
	{220, 0x4c, EM_GPU_DEVICE_2},
};
...
static int find_gpu_index(int gpu_no)
{
	int i;
...
static int i2c_raw_access(int i2c_bus, int i2c_addr, int flag_read_write, short len , char *data_bytes)
{
	int fd;
	char filename[MAX_I2C_DEV_LEN] = {0};
	int rc=-1;
